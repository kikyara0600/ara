...
<div class="header-content">
    ...
    <div class="content" id="1">
        <h1  style="color:#dbaf6c ;"><CENTER>KESEHATAN</CENTER></h1>
        <h2 style="color:#dbaf6c ;">Program Peningkatan Kesehatan Masyarakat</h2>
        <p><strong>Tanggal Mulai:</strong> 1 Agustus 2024</p>
        <p><strong>Deskripsi:</strong> Program ini bertujuan untuk meningkatkan kualitas kesehatan masyarakat di Kelurahan Temuwuh melalui berbagai inisiatif dan layanan kesehatan.</p>
        
        <h3>Tujuan Program</h3>
        <ul>
            <li>Meningkatkan akses masyarakat terhadap layanan kesehatan.</li>
            <li>Menyediakan edukasi kesehatan untuk masyarakat.</li>
            <li>Menurunkan angka penyakit menular dan tidak menular.</li>
            <li>Meningkatkan kualitas sanitasi dan kebersihan lingkungan.</li>
        </ul>

        <h3>Kegiatan yang Direncanakan</h3>
        <ul>
            <li>Kampanye dan penyuluhan kesehatan.</li>
            <li>Program imunisasi dan pemeriksaan kesehatan gratis.</li>
            <li>Pembangunan fasilitas sanitasi.</li>
            <li>Kegiatan olahraga dan kebugaran untuk masyarakat.</li>
        </ul>

        <h3>Galeri Kegiatan</h3>
        <div class="gallery">
        <div class="gallery-item">
            <img src="aset/kesehatan1.jpeg" alt="Kegiatan Kesehatan 1">
        </div>
        <div class="gallery-item">
            <img src="aset/kesehatan2.jpeg" alt="Kegiatan Kesehatan 2">
        </div>
        <div class="gallery-item">
            <video controls>
                <source src="aset/kesehatan3.mp4" type="video/mp4">
