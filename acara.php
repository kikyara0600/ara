...
<div class="header-content">
    ...
    <div class="content" id="1">
        <h1 style="color:#dbaf6c ;"><CENTER>ACARA</CENTER></h1>
        <ul>
            <li>
                <h3>Musyawarah Desa</h3>
                <p>Tanggal: 10 Juli 2024</p>
                <p>Lokasi: Balai Desa Temuwuh</p>
                <p>Deskripsi: Pertemuan warga desa untuk membahas rencana pembangunan desa.</p>
            </li>
            <li>
                <h3>Festival Budaya</h3>
                <p>Tanggal: 20 Agustus 2024</p>
                <p>Lokasi: Lapangan Temuwuh</p>
                <p>Deskripsi: Perayaan budaya lokal dengan berbagai pertunjukan seni dan kuliner tradisional.</p>
            </li>
            <li>
                <h3>Pelatihan Keterampilan</h3>
                <p>Tanggal: 15 September 2024</p>
                <p>Lokasi: Gedung Serbaguna</p>
                <p>Deskripsi: Pelatihan keterampilan bagi warga desa untuk meningkatkan kemampuan kerja.</p>
            </li>
        </ul>
    </main>
